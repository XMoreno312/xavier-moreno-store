...
const TIER_TERMS = {
  mp3: {
    ...
    terms: [
      ...
      "Producer credit required: “Produced by Zae Moreno” in song title or first line of credits.",
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .fontSize(11)
        .text(
          `This Non-Exclusive License Agreement (the “Agreement”) is entered into on ${executionDate} between Zae Moreno (“Licensor”, “Producer”) and ${buyer} (“Licensee”), reachable at ${buyerEmailLine}.`,
      ...
      doc
        ...
        .fontSize(11)
        .text(
          "Producer credit must appear in the song title or first line of the credits as: “Produced by Zae Moreno”. Failure to provide credit constitutes a material breach of this Agreement.",
          { lineGap: 2 },
        );
      doc.moveDown(0.6);
      ...
      doc
        .font("Times-Italic")
        .fontSize(11)
        .text("Zae Moreno", doc.page.margins.left, sigY + 6);
      doc
        .font("Times-Roman")
        .fontSize(9.5)
        .fillColor("#555555")
        .text("Zae Moreno — Producer", doc.page.margins.left, sigY + 32);
      doc
        .fillColor("#555555")
        .fontSize(9.5)
      ...
      doc
        ...
        .fillColor("#888888")
        .text(
          "Zae Moreno — producer, songwriter. zaemoreno.com",
